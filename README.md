...
- three pot strain assignments per tent in setup and display below the dashboard camera stream
...
```text
ghcr.io/syschelle/growtent-backend-api:v0.263
```
...
```bash
GT_API_IMAGE=ghcr.io/syschelle/growtent-backend-api:v0.263 docker compose -f docker-compose.images.yml pull
GT_API_IMAGE=ghcr.io/syschelle/growtent-backend-api:v0.263 docker compose -f docker-compose.images.yml up -d --remove-orphans
```
