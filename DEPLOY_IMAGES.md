...
```text
ghcr.io/syschelle/growtent-backend-api:v0.290
```
...
```bash
GT_API_IMAGE=ghcr.io/syschelle/growtent-backend-api:v0.290 docker compose -f docker-compose.images.yml pull
GT_API_IMAGE=ghcr.io/syschelle/growtent-backend-api:v0.290 docker compose -f docker-compose.images.yml up -d --force-recreate --remove-orphans
```
